...
namespace aegis
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // addel
            bundles.Add(new ScriptBundle("~/plugins/addel").Include(
                        "~/Content/plugins/addel/addel.jquery.min.js"));

            // serializejson
            bundles.Add(new ScriptBundle("~/plugins/serializejson").Include(
                        "~/Content/plugins/serializejson/jquery.serializejson.js"));
